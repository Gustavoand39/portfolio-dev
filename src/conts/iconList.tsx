...
export const iconList: IIconList = {
  html5: <FaHtml5 className="text-blue-500" size={40} />,
  ...
  github: <FaGithub className="text-black dark:text-white" size={40} />,
  mysql: <SiMysql className="text-blue-600" size={40} />,
  express: <SiExpress className="text-black dark:text-white" size={40} />,
  socket: <SiSocketdotio className="text-black dark:text-white" size={40} />,
};
