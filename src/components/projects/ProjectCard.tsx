...
export const ProjectCard = ({ project }: Props) => {
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between gap-8 rounded-lg bg-slate-500/50 dark:bg-slate-800/50 opacity-0 hover:md:opacity-100 p-8 z-10 backdrop-blur-lg transition-all duration-300">
